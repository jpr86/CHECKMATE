...
/**
 * Interface declaring methods for objects containing receivers.
 * @author Jeff Ridder
 */
public interface IReceiverContainer
{
    /**
     * Method to be called by embedded receivers to report emitter tracks to their parent
     * platform.
